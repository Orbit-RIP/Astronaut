...
public class ItemBuilderr {
    ...
    public ItemBuilderr(Material material) {
     ...
     */
    public ItemBuilderr setDisplayName(String newName) {
     ...
     */
    public ItemBuilderr addLore(String toAdd) {
        ItemMeta meta = this.stack.getItemMeta();
     ...
     */
    public ItemBuilderr setLore(List<String> toSet) {
        ItemMeta meta = this.stack.getItemMeta();
    ...
    */
    public ItemBuilderr setData(int newData) {
    ...
    */
    public ItemBuilderr setAmount(int newAmount) {
